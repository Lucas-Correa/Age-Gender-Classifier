...
def download_clean_processImages(): 
    ...
    #droop images without a gender
    fold.dropna(subset=['gender'],inplace=True)
    
    
    #drop images withou age
    fold = fold.loc[fold.age !='None']
    
    
    #organize ages in beter classifications
    ...
    #split data into train and test considering gender stratify
